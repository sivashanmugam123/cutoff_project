...
function ExAlertModelPopup() {
  ...
  return (
    <div>
      ...
      <a onClick={modalShow}>Alerts & Updates</a>
      <Modal show={show} onHide={modalClose}>
        <Modal.Header closeButton>
          <Modal.Title>Enter your Query for Alerts & Updates</Modal.Title>
        </Modal.Header>
...
export default ExAlertModelPopup;
