...
function ChoiceModelPopup() {
  ...
  return (
    <div>
      {" "}
      <img className="iconsize1" src={app3} alt="Logo" />
      <a onClick={modalShow}>Choice Filling Support</a>
      <Modal show={show} onHide={modalClose}>
        <Modal.Header closeButton>
          <Modal.Title>Enter Choice Filling Query</Modal.Title>
        </Modal.Header>
...
export default ChoiceModelPopup;
